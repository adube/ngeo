...
app.MainController = function(ngeoDecorateGeolocation) {
  var view = new ol.View({center:[647019, 6239641], zoom:4});
  this.map = new ol.Map({layers:[new ol.layer.Tile({source:new ol.source.OSM})], view:view});
  var map = this.map;
  this.geolocation = new ol.Geolocation({projection:view.getProjection()});
  ...
  var vectorLayer = new ol.layer.Vector({source:new ol.source.Vector({features:[positionFeature, accuracyFeature]})});
