...
ol.control.MousePosition = function(opt_options) {
  ...
  ol.control.Control.call(this, {element:element, render:render, target:options.target});
  ol.events.listen(this, ol.Object.getChangeEventType(ol.control.MousePosition.Property.PROJECTION), this.handleProjectionChanged_, this);
...
ol.control.MousePosition.prototype.getCoordinateFormat = function() {
  return (this.get(ol.control.MousePosition.Property.COORDINATE_FORMAT));
};
ol.control.MousePosition.prototype.getProjection = function() {
  return (this.get(ol.control.MousePosition.Property.PROJECTION));
};
...
ol.control.MousePosition.Property = {PROJECTION:"projection", COORDINATE_FORMAT:"coordinateFormat"};
...
app.MainController = function() {
  ...
  this.control = new ol.control.MousePosition({className:"mouse-position"});
};
