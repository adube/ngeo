...
app.backgroundlayerDirective = function() {
  return {restrict:"E", scope:{"map":"=appBackgroundlayerMap"}, templateUrl:"partials/backgroundlayerdropdown.html", bindToController:true, controller:"AppBackgroundlayerController as ctrl"};
};
