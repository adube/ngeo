...
ngeo.modalDirective = function($parse) {
  return {template:'<div class="modal fade" tabindex="-1" role="dialog">' + '<div class="modal-dialog">' + '<div class="modal-content">' + "</div>" + "</div>" + "</div>", restrict:"E", require:"ngModel", transclude:true, link:function(scope, element, attrs, ngModelController, transcludeFn) {
