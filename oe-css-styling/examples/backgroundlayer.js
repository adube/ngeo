...
app.backgroundlayerDirective = function() {
  return {restrict:"E", scope:{"map":"=appBackgroundlayerMap"}, templateUrl:"partials/backgroundlayer.html", controllerAs:"ctrl", bindToController:true, controller:"AppBackgroundlayerController"};
};
...
app.MainController = function($scope) {
  this.map = new ol.Map({view:new ol.View({center:[-1.063514237E7, 4813698.29], zoom:4})});
