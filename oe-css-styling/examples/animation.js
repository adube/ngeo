...
ngeo.resizemapDirective = function($window) {
  ...
  return {restrict:"A", link:function(scope, element, attrs) {
    ...
    var start;
    var animationDelay = new goog.async.AnimationDelay(function() {
      map.updateSize();
      map.renderSync();
...
app.mapDirective = function() {
  return {restrict:"E", scope:{"map":"=appMap", "class":"=appMapClass"}, controller:function() {
  }, controllerAs:"ctrl", bindToController:true, template:'<div ngeo-map="ctrl.map"></div>'};
};
