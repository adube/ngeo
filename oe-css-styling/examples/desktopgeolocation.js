...
goog.require("ol.Map");
goog.require("ol.geom.Point");
ngeo.DesktopGeolocationEventType = {ERROR:"desktop-geolocation-error"};
ngeo.desktopGeolocationDirective = function() {
  return {restrict:"A", scope:{"getDesktopMapFn":"&ngeoDesktopGeolocationMap", "getDesktopGeolocationOptionsFn":"&ngeoDesktopGeolocationOptions"}, controller:"NgeoDesktopGeolocationController", controllerAs:"ctrl"};
};
ngeo.module.directive("ngeoDesktopGeolocation", ngeo.desktopGeolocationDirective);
ngeo.DesktopGeolocationController = function($scope, $element, ngeoDecorateGeolocation, ngeoFeatureOverlayMgr, ngeoNotification) {
...
ngeo.module.controller("NgeoDesktopGeolocationController", ngeo.DesktopGeolocationController);
...
app.MainController = function($scope, ngeoFeatureOverlayMgr) {
  ...
  this.desktopGeolocationOptions = {positionFeatureStyle:positionFeatureStyle, accuracyFeatureStyle:accuracyFeatureStyle, zoom:17};
