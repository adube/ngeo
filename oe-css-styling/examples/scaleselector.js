...
goog.require("ol.Object");
goog.require("ol.events");
ngeo.module.value("ngeoScaleselectorTemplateUrl", function(element, attrs) {
  var templateUrl = attrs["ngeoScaleselectorTemplateurl"];
  return templateUrl !== undefined ? templateUrl : ngeo.baseTemplateUrl + "/scaleselector.html";
});
ngeo.ScaleselectorOptions;
ngeo.scaleselectorDirective = function(ngeoScaleselectorTemplateUrl) {
  return {restrict:"A", scope:true, controller:"NgeoScaleselectorController", templateUrl:ngeoScaleselectorTemplateUrl};
};
...
ngeo.ScaleselectorController = function($scope, $element, $attrs) {
  ...
  ol.events.listen(this.map_, ol.Object.getChangeEventType("view"), this.handleViewChange_, this);
...
ngeo.ScaleselectorController.prototype.registerResolutionChangeListener_ = function() {
  ...
  var view = this.map_.getView();
  this.resolutionChangeKey_ = ol.events.listen(view, ol.Object.getChangeEventType("resolution"), this.handleResolutionChange_, this);
};
ngeo.module.controller("NgeoScaleselectorController", ngeo.ScaleselectorController);
...
ngeo.DMSCoordinates = function() {
  var degreesToStringHDMS = function(degrees, hemispheres, fractionDigits) {
    ...
    var s = dms % 60;
    return d + "\u00b0 " + ol.string.padNumber(m, 2) + "\u2032 " + ol.string.padNumber(s, 2, fractionDigits) + "\u2033 " + hemispheres.charAt(normalizedDegrees < 0 ? 1 : 0);
  };
  var filterFn = function(coordinates, opt_fractionDigits, opt_template) {
    var fractionDigits = parseInt(opt_fractionDigits, 10) | 0;
    var template = opt_template ? opt_template : "{x} {y}";
...
app.scaleselectorDirective = function() {
  return {restrict:"E", scope:{"map":"=appScaleselectorMap"}, template:'<div ngeo-scaleselector="ctrl.scales" ' + 'ngeo-scaleselector-map="ctrl.map" ' + 'ngeo-scaleselector-options="ctrl.options"></div>', controllerAs:"ctrl", bindToController:true, controller:"AppScaleselectorController"};
};
app.module.directive("appScaleselector", app.scaleselectorDirective);
app.ScaleselectorController = function($sce) {
  this.map;
  this.scales = {0:$sce.trustAsHtml("1&nbsp;:&nbsp;200'000'000"), 1:$sce.trustAsHtml("1&nbsp;:&nbsp;100'000'000"), 2:$sce.trustAsHtml("1&nbsp;:&nbsp;50'000'000"), 3:$sce.trustAsHtml("1&nbsp;:&nbsp;25'000'000"), 4:$sce.trustAsHtml("1&nbsp;:&nbsp;12'000'000")};
  this.options = {"dropup":true};
};
app.module.controller("AppScaleselectorController", app.ScaleselectorController);
app.MainController = function($scope) {
  this.map = new ol.Map({layers:[new ol.layer.Tile({source:new ol.source.OSM})], view:new ol.View({center:[-1.063514237E7, 4813698.29], zoom:1, maxZoom:4})});
};
