...
ngeo.FeatureOverlayMgr = function() {
  ...
  this.groups_ = [];
  this.source_ = new ol.source.Vector({useSpatialIndex:false});
  this.layer_ = new ol.layer.Vector({source:this.source_, style:this.styleFunction_.bind(this), updateWhileAnimating:true, updateWhileInteracting:true});
};
...
ngeo.FeatureOverlayMgr.prototype.getFeatureOverlay = function() {
  ...
  this.groups_.push({styleFunction:ol.style.Style.defaultFunction, features:{}});
...
ngeo.FeatureOverlayMgr.prototype.setStyle = function(style, groupIndex) {
  goog.asserts.assert(groupIndex >= 0);
  goog.asserts.assert(groupIndex < this.groups_.length);
  this.groups_[groupIndex].styleFunction = style === null ? ol.style.Style.defaultFunction : ol.style.Style.createFunction(style);
};
...
ngeo.FeatureOverlay.prototype.setFeatures = function(features) {
  ...
  if (features !== null) {
    ...
    ol.events.listen(features, ol.Collection.EventType.ADD, this.handleFeatureAdd_, this);
    ol.events.listen(features, ol.Collection.EventType.REMOVE, this.handleFeatureRemove_, this);
  }
...
ngeo.decorateGeolocation = function(geolocation) {
  ...
  Object.defineProperty(geolocation, "tracking", {get:function() {
...
ngeo.MessageType = {ERROR:"error", INFORMATION:"information", SUCCESS:"success", WARNING:"warning"};
...
ngeo.Message.prototype.getMessageObjects = function(object, opt_type) {
  ...
  if (typeof object === "string") {
    msgObjects.push({msg:object, type:opt_type !== undefined ? opt_type : defaultType});
  } else {
    if (Array.isArray(object)) {
      object.forEach(function(msg) {
        if (typeof object === "string") {
          msgObject = {msg:msg, type:opt_type !== undefined ? opt_type : defaultType};
        } else {
          msgObject = msg;
...
ngeo.Notification.DEFAULT_DELAY_ = 7E3;
...
ngeo.Notification.prototype.showMessage = function(message) {
  ...
  var delay = message.delay !== undefined ? message.delay : ngeo.Notification.DEFAULT_DELAY_;
  var item = ({el:el});
...
ol.Geolocation = function(opt_options) {
  ...
  ol.events.listen(this, ol.Object.getChangeEventType(ol.Geolocation.Property.PROJECTION), this.handleProjectionChanged_, this);
  ol.events.listen(this, ol.Object.getChangeEventType(ol.Geolocation.Property.TRACKING), this.handleTrackingChanged_, this);
...
ol.Geolocation.prototype.handleProjectionChanged_ = function() {
  ...
  if (projection) {
    ...
    if (this.position_) {
      this.set(ol.Geolocation.Property.POSITION, this.transform_(this.position_));
    }
  }
};
...
ol.Geolocation.prototype.positionChange_ = function(position) {
  ...
  this.set(ol.Geolocation.Property.ALTITUDE, coords.altitude === null ? undefined : coords.altitude);
  this.set(ol.Geolocation.Property.ALTITUDE_ACCURACY, coords.altitudeAccuracy === null ? undefined : coords.altitudeAccuracy);
  this.set(ol.Geolocation.Property.HEADING, coords.heading === null ? undefined : ol.math.toRadians(coords.heading));
  if (!this.position_) {
  ...
  this.set(ol.Geolocation.Property.SPEED, coords.speed === null ? undefined : coords.speed);
...
ol.Geolocation.prototype.getAccuracy = function() {
  return (this.get(ol.Geolocation.Property.ACCURACY));
};
ol.Geolocation.prototype.getAccuracyGeometry = function() {
  return (this.get(ol.Geolocation.Property.ACCURACY_GEOMETRY) || null);
};
ol.Geolocation.prototype.getAltitude = function() {
  return (this.get(ol.Geolocation.Property.ALTITUDE));
};
ol.Geolocation.prototype.getAltitudeAccuracy = function() {
  return (this.get(ol.Geolocation.Property.ALTITUDE_ACCURACY));
};
ol.Geolocation.prototype.getHeading = function() {
  return (this.get(ol.Geolocation.Property.HEADING));
};
ol.Geolocation.prototype.getPosition = function() {
  return (this.get(ol.Geolocation.Property.POSITION));
};
ol.Geolocation.prototype.getProjection = function() {
  return (this.get(ol.Geolocation.Property.PROJECTION));
};
ol.Geolocation.prototype.getSpeed = function() {
  return (this.get(ol.Geolocation.Property.SPEED));
};
ol.Geolocation.prototype.getTracking = function() {
  return (this.get(ol.Geolocation.Property.TRACKING));
};
ol.Geolocation.prototype.getTrackingOptions = function() {
  return (this.get(ol.Geolocation.Property.TRACKING_OPTIONS));
};
...
ol.Geolocation.Property = {ACCURACY:"accuracy", ACCURACY_GEOMETRY:"accuracyGeometry", ALTITUDE:"altitude", ALTITUDE_ACCURACY:"altitudeAccuracy", HEADING:"heading", POSITION:"position", PROJECTION:"projection", SPEED:"speed", TRACKING:"tracking", TRACKING_OPTIONS:"trackingOptions"};
...
goog.require("ol.View");
goog.require("ol.geom.Point");
ngeo.MobileGeolocationEventType = {ERROR:"mobile-geolocation-error"};
ngeo.mobileGeolocationDirective = function() {
  return {restrict:"A", scope:{"getMobileMapFn":"&ngeoMobileGeolocationMap", "getMobileGeolocationOptionsFn":"&ngeoMobileGeolocationOptions"}, controller:"NgeoMobileGeolocationController", controllerAs:"ctrl"};
};
ngeo.module.directive("ngeoMobileGeolocation", ngeo.mobileGeolocationDirective);
ngeo.MobileGeolocationController = function($scope, $element, ngeoDecorateGeolocation, ngeoFeatureOverlayMgr, ngeoNotification) {
  ...
  this.geolocation_ = new ol.Geolocation({projection:map.getView().getProjection()});
  ...
  ol.events.listen(this.geolocation_, ol.Object.getChangeEventType(ol.Geolocation.Property.ACCURACY_GEOMETRY), function() {
    this.accuracyFeature_.setGeometry(this.geolocation_.getAccuracyGeometry());
  }, this);
  ol.events.listen(this.geolocation_, ol.Object.getChangeEventType(ol.Geolocation.Property.POSITION), function(e) {
    this.setPosition_(e);
  }, this);
  var view = map.getView();
  ol.events.listen(view, ol.Object.getChangeEventType(ol.View.Property.CENTER), this.handleViewChange_, this);
  ol.events.listen(view, ol.Object.getChangeEventType(ol.View.Property.RESOLUTION), this.handleViewChange_, this);
  ol.events.listen(view, ol.Object.getChangeEventType(ol.View.Property.ROTATION), this.handleViewChange_, this);
...
app.MainController = function($scope, ngeoFeatureOverlayMgr) {
  var positionFeatureStyle = new ol.style.Style({image:new ol.style.Circle({radius:6, fill:new ol.style.Fill({color:"rgba(230, 100, 100, 1)"}), stroke:new ol.style.Stroke({color:"rgba(230, 40, 40, 1)", width:2})})});
  var accuracyFeatureStyle = new ol.style.Style({fill:new ol.style.Fill({color:"rgba(100, 100, 230, 0.3)"}), stroke:new ol.style.Stroke({color:"rgba(40, 40, 230, 1)", width:2})});
  this.mobileGeolocationOptions = {positionFeatureStyle:positionFeatureStyle, accuracyFeatureStyle:accuracyFeatureStyle, zoom:17};
  this.map = new ol.Map({layers:[new ol.layer.Tile({source:new ol.source.OSM})], view:new ol.View({center:[0, 0], zoom:4})});
