...
goog.require("ol.source.WMTS");
goog.require("ol.tilegrid.WMTS");
ngeo.source.AsitVDResolutions_ = [4E3, 3750, 3500, 3250, 3E3, 2750, 2500, 2250, 2E3, 1750, 1500, 1250, 1E3, 750, 650, 500, 250, 100, 50, 20, 10, 5, 2.5, 2, 1.5, 1, .5];
ngeo.source.AsitVDTileGrid_ = new ol.tilegrid.WMTS({extent:[42E4, 3E4, 9E5, 35E4], resolutions:ngeo.source.AsitVDResolutions_, matrixIds:ngeo.source.AsitVDResolutions_.map(function(value, index) {
  return String(index);
})});
ngeo.source.AsitVD = function(options) {
  ol.source.WMTS.call(this, {attributions:[ngeo.source.AsitVD.ATTRIBUTION_], url:"https://ows{1-4}.asitvd.ch/wmts/1.0.0/{Layer}/default/default/0/" + "21781/{TileMatrix}/{TileRow}/{TileCol}.png", projection:"EPSG:21781", requestEncoding:"REST", layer:options.layer, style:"default", matrixSet:"21781", format:"image/png", tileGrid:ngeo.source.AsitVDTileGrid_});
};
ol.inherits(ngeo.source.AsitVD, ol.source.WMTS);
ngeo.source.AsitVD.ATTRIBUTION_ = new ol.Attribution({html:"g\u00e9odonn\u00e9es &copy; Etat de Vaud & &copy; contributeurs OpenStreetMap"});
...
app.MainController = function() {
  this.map = new ol.Map({layers:[new ol.layer.Tile({source:new ngeo.source.AsitVD({layer:"asitvd.fond_couleur"})})], view:new ol.View({resolutions:[250, 100, 50, 20, 10, 5, 2.5, 2, 1.5, 1, .5], center:[535E3, 154E3], zoom:0})});
};
...
//# sourceMappingURL=asitvd.js.map
