...
app.MainController.prototype.notifyMulti = function() {
  this.notification.notify([{msg:["Error #", this.i_++].join(""), type:ngeo.MessageType.ERROR}, {msg:["Warning #", this.i_++].join(""), type:ngeo.MessageType.WARNING}, {msg:["Information #", this.i_++].join(""), type:ngeo.MessageType.INFORMATION}, {msg:["Success #", this.i_++].join(""), type:ngeo.MessageType.SUCCESS}]);
};
app.MainController.prototype.notifyTarget = function() {
  this.notification.notify({msg:"Error in an other target", target:angular.element("#my-messages"), type:ngeo.MessageType.ERROR});
};
app.MainController.prototype.notifyQuick = function() {
  this.notification.notify({delay:1E3, msg:"Lasts one second", type:ngeo.MessageType.SUCCESS});
};
