...
app.MainController = function($scope, ngeoDecorateLayerLoading) {
  ...
  this.wms = new ol.layer.Image({source:new ol.source.ImageWMS({url:"http://demo.boundlessgeo.com/geoserver/wms", params:{"LAYERS":"topp:states"}, serverType:"geoserver"})});
  ngeoDecorateLayerLoading(this.wms, $scope);
  this.map = new ol.Map({layers:[this.osm, this.wms], view:new ol.View({center:[0, 0], zoom:1})});
};
...
//# sourceMappingURL=layerloading.js.map
