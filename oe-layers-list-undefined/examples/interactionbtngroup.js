...
app.MainController = function(ngeoDecorateInteraction, ngeoFeatureOverlayMgr) {
  ...
  this.map = new ol.Map({layers:[new ol.layer.Tile({source:new ol.source.OSM})], view:new ol.View({center:[-10997148, 4569099], zoom:4})});
  var map = this.map;
...
//# sourceMappingURL=interactionbtngroup.js.map
