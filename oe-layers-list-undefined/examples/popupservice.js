...
app.MainController.prototype.heavyPopup = function() {
  ...
  var content = this.sce_.trustAsHtml("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla eget" + "quam at ex euismod bibendum et eget enim. Nulla sodales tortor ac" + "sagittis aliquet. Ut malesuada quam vitae pulvinar porta. Nunc id" + "magna id risus malesuada elementum eget id purus. Curabitur vel augue" + "blandit, faucibus nulla quis, consequat tellus. Phasellus commodo," + "tellus et vulputate ultricies, nulla libero ornare arcu, quis" + "fermentum sem diam quis tellus. Aliquam ut sapien tristique, lacinia" + 
  "ante et, lacinia arcu. Quisque sagittis eros at quam blandit" + "gravida. Nulla sit amet enim semper, efficitur eros sit amet," + "porttitor libero. Fusce quis tellus est. Quisque ornare, ex eget" + "luctus pharetra, nisl leo lobortis purus, sed tristique neque leo eget" + "odio. Maecenas lobortis nisl ac magna mollis, ac pulvinar risus" + "convallis. Donec ullamcorper sollicitudin maximus. Quisque bibendum" + "elit sit amet ultrices ornare. Donec aliquam felis id urna ultrices" + "scelerisque.");
  popup.setContent(content);
  popup.setOpen(true);
};
app.MainController.prototype.openPopupWithContent = function() {
  ...
  popup.open({autoDestroy:true, content:content, height:"200px", title:'Opened with "open"', width:"300px"});
};
app.MainController.prototype.openPopupWithUrl = function() {
  var popup = this.createPopup_();
  popup.open({autoDestroy:true, cls:"popup-with-iframe", height:"300px", title:'Opened with "open" and "iframe"', url:"http://geomapfish.org/", width:"400px"});
};
