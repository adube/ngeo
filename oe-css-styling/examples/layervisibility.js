...
app.MainController = function(ngeoDecorateLayer) {
  this.layer = new ol.layer.Tile({source:new ol.source.TileWMS({url:"http://demo.opengeo.org/geoserver/wms", params:{"LAYERS":"topp:states"}, serverType:"geoserver", extent:[-13884991, 2870341, -7455066, 6338219]})});
  var wmsLayer = this.layer;
  ngeoDecorateLayer(wmsLayer);
  this.map = new ol.Map({layers:[new ol.layer.Tile({source:new ol.source.OSM}), wmsLayer], view:new ol.View({center:[-10997148, 4569099], zoom:4})});
};
...
//# sourceMappingURL=layervisibility.js.map
