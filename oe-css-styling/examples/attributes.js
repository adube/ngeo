...
ngeo.format.XSDAttribute.prototype.read = function(source) {
  return (ol.format.XML.prototype.read.call(this, source));
};
ngeo.format.XSDAttribute.prototype.readFromDocument = function(doc) {
  goog.asserts.assert(doc.nodeType == Node.DOCUMENT_NODE, "doc.nodeType should be DOCUMENT");
...
ngeo.format.XSDAttribute.prototype.readFromNode = function(node) {
  goog.asserts.assert(node.nodeType == Node.ELEMENT_NODE, "node.nodeType should be ELEMENT");
  goog.asserts.assert(node.localName == "schema", "localName should be schema");
...
ngeo.format.XSDAttribute.prototype.readFromElementNode_ = function(node) {
  ...
  var attribute = {name:name, required:required};
...
ngeo.format.XSDAttributeType = {DATE:"date", DATETIME:"datetime", GEOMETRY:"geometry", SELECT:"select", TEXT:"text"};
...
ngeo.EventHelper.prototype.addListenerKey = function(uid, key, opt_isol) {
  ...
  if (isol) {
    this.listenerKeys_[uid].ol.push((key));
  } else {
    this.listenerKeys_[uid].goog.push((key));
  }
};
...
ngeo.EventHelper.prototype.initListenerKey_ = function(uid) {
  if (!this.listenerKeys_[uid]) {
    this.listenerKeys_[uid] = {goog:[], ol:[]};
  } else {
...
ngeo.attributesDirective = function() {
  return {controller:"ngeoAttributesController", scope:true, bindToController:{"attributes":"=ngeoAttributesAttributes", "disabled":"<ngeoAttributesDisabled", "feature":"=ngeoAttributesFeature"}, controllerAs:"attrCtrl", templateUrl:ngeo.baseTemplateUrl + "/attributes.html"};
};
...
ngeo.AttributesController = function($scope, ngeoEventHelper) {
  ...
  this.dateOptions = {"changeMonth":true, "changeYear":true};
  var uid = ol.getUid(this);
  this.ngeoEventHelper_.addListenerKey(uid, ol.events.listen(this.feature, ol.ObjectEventType.PROPERTYCHANGE, this.handleFeaturePropertyChange_, this), true);
...
app.MainController = function($http, $timeout) {
  ...
  this.disabled = false;
  this.feature = new ol.Feature({"name":"A feature", "kind":"house"});
