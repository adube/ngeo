...
app.searchDirective = function() {
  return {restrict:"E", scope:{"map":"=appSearchMap"}, controller:"AppSearchController as ctrl", bindToController:true, template:'<input type="text" placeholder="search\u2026" ' + 'ngeo-search="ctrl.options" ' + 'ngeo-search-datasets="ctrl.datasets" ' + 'ngeo-search-listeners="ctrl.listeners">', link:function(scope, element, attrs) {
