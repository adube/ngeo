...
goog.require("ol.source.WMTS");
ngeo.BackgroundEventType = {CHANGE:"change"};
...
ngeo.BackgroundLayerMgr.prototype.set = function(map, layer) {
  ...
  this.dispatchEvent(new ngeo.BackgroundEvent(ngeo.BackgroundEventType.CHANGE, previous));
  return previous;
};
...
app.backgroundlayerDirective = function() {
  return {restrict:"E", scope:{"map":"=appBackgroundlayerMap"}, templateUrl:"partials/backgroundlayerdropdown.html", controllerAs:"ctrl", bindToController:true, controller:"AppBackgroundlayerController"};
};
...
app.module.controller("AppBackgroundlayerController", app.BackgroundlayerController);
app.MainController = function($scope) {
  var map = new ol.Map({view:new ol.View({center:[-1.063514237E7, 4813698.29], zoom:4})});
  this["map"] = map;
  var overlay = new ol.layer.Image({source:new ol.source.ImageWMS({url:"http://demo.boundlessgeo.com/geoserver/wms", params:{"LAYERS":"topp:states"}, serverType:"geoserver"})});
