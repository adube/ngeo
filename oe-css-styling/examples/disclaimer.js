...
ngeo.Disclaimer.prototype.showMessage = function(message) {
  ...
  if (showInPopup) {
    ...
    popup.open({autoDestroy:true, content:content, title:"&nbsp;"});
    ...
    var button = angular.element('<button type="button" class="close" data-dismiss="alert" aria-label="' + this.gettextCatalog_.getString("Close") + '"><span aria-hidden="true" class="fa fa-times"></span></button>');
...
app.MainController.prototype.inMap = function() {
  this.inMapMsgs_.forEach(function(message) {
    this.disclaimer.alert({msg:message, target:angular.element("#disclaimers-in-map"), type:ngeo.MessageType.WARNING});
  }, this);
};
app.MainController.prototype.closeAll = function() {
  this.disclaimer.close({msg:this.successMsg_, type:ngeo.MessageType.SUCCESS});
  this.disclaimer.close({msg:this.infoMsg_, type:ngeo.MessageType.INFORMATION});
  this.disclaimer.close({msg:this.warningMsg_, type:ngeo.MessageType.WARNING});
  this.disclaimer.close({msg:this.errorMsg_, type:ngeo.MessageType.ERROR});
  this.inMapMsgs_.forEach(function(message) {
    this.disclaimer.close({msg:message, type:ngeo.MessageType.WARNING});
  }, this);
};
