...
goog.require("ngeo");
ngeo.module.value("ngeoColorpickerTemplateUrl", function(element, attrs) {
  var templateUrl = attrs["ngeoColorpickerTemplateurl"];
  return templateUrl !== undefined ? templateUrl : ngeo.baseTemplateUrl + "/colorpicker.html";
});
ngeo.colorpickerDirective = function(ngeoColorpickerTemplateUrl) {
  return {restrict:"A", scope:{colors:"<?ngeoColorpicker", color:"=?ngeoColorpickerColor"}, controller:"NgeoColorpickerController", controllerAs:"ctrl", bindToController:true, templateUrl:ngeoColorpickerTemplateUrl};
};
ngeo.module.directive("ngeoColorpicker", ngeo.colorpickerDirective);
var defaultColors = [["#F4EB37", "#CDDC39", "#62AF44", "#009D57", "#0BA9CC", "#4186F0", "#3F5BA9", "#7C3592", "#A61B4A", "#DB4436", "#F8971B", "#F4B400", "#795046"], ["#F9F7A6", "#E6EEA3", "#B7DBAB", "#7CCFA9", "#93D7E8", "#9FC3FF", "#A7B5D7", "#C6A4CF", "#D698AD", "#EE9C96", "#FAD199", "#FFDD5E", "#B29189"], ["#ffffff", "#CCCCCC", "#777", "#000000"]];
...
ngeo.module.controller("NgeoColorpickerController", ngeo.ColorpickerController);
goog.provide("app.colorpicker");
goog.require("ngeo.mapDirective");
goog.require("ngeo.colorpickerDirective");
app.module = angular.module("app", ["ngeo"]);
app.colorpickerDirective = function() {
  return {restrict:"E", scope:true, template:'<div ngeo-colorpicker="ctrl.colors" ngeo-colorpicker-color="mainCtrl.color"></div>', controllerAs:"ctrl", bindToController:true, controller:"AppColorpickerController"};
};
...
app.module.controller("AppColorpickerController", app.ColorPickerController);
