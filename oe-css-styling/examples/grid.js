...
ngeo.module.value("ngeoGridTemplateUrl", function(element, attrs) {
  var templateUrl = attrs["ngeoGridTemplateurl"];
  return templateUrl !== undefined ? templateUrl : ngeo.baseTemplateUrl + "/grid.html";
});
...
ngeo.gridDirective = function(ngeoGridTemplateUrl) {
  return {bindToController:true, controller:"ngeoGridController", controllerAs:"ctrl", restrict:"E", scope:{"configuration":"=ngeoGridConfiguration"}, templateUrl:ngeoGridTemplateUrl};
};
...
ngeo.GridController = function($scope) {
  ...
  this.floatTheadConfig = {"scrollContainer":function($table) {
...
ngeo.GridController.prototype.clickRow_ = function(attributes, shiftKey, platformModifierKey) {
...
ngeo.GridController.prototype.selectRange_ = function(attributes) {
  ...
  for (var i = 0;i < data.length;i++) {
    ...
    if (targetUid === currentUid) {
      ...
      if (this.configuration.isRowSelected(currentRow)) {
...
ngeo.GridController.prototype.isPlatformModifierKeyOnly_ = function(event) {
  return !event.altKey && (ol.has.MAC ? event.metaKey : event.ctrlKey) && !event.shiftKey;
};
...
app.MainController = function() {
  var data = [{"name":"row_1", "display_name":"Row 1", "type":12, "timestamp":"2010-11-09T22:56:26Z"}, {"name":"row_2", "display_name":"Row 2", "type":121, "timestamp":"2010-11-07T22:56:26Z"}, {"name":"row_3", "display_name":"Row 3", "type":7, "timestamp":"2010-11-03T22:56:26Z"}, {"name":"row_4", "display_name":"Row 4", "type":5, "timestamp":"2010-11-19T22:56:26Z"}, {"name":"row_5", "display_name":"Row 5", "type":23, "timestamp":"2010-11-23T22:56:26Z"}, {"name":"row_6", "display_name":"Row 6", "type":111, 
  "timestamp":"2010-11-17T22:56:26Z"}];
  var columnDefs = [{name:"name"}, {name:"display_name"}, {name:"timestamp"}, {name:"type"}];
