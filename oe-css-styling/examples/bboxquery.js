...
ngeo.bboxQueryDirective = function(ngeoQuery) {
  return {restrict:"A", scope:false, link:function(scope, elem, attrs) {
    ...
    var interaction = new ol.interaction.DragBox({condition:ol.events.condition.platformModifierKeyOnly});
    ...
    scope.$watch(attrs["ngeoBboxQueryActive"], function(newVal, oldVal) {
      if (newVal) {
...
app.MainController = function($scope, ngeoQuery) {
  ...
  var busStopLayer = new ol.layer.Image({"querySourceId":busStopSourceId, "source":new ol.source.ImageWMS({"url":"https://geomapfish-demo.camptocamp.net/1.6/wsgi/mapserv_proxy", params:{"LAYERS":"bus_stop"}})});
  ngeoQuery.addSource({"id":busStopSourceId, "layer":busStopLayer, "wfsQuery":true});
  var informationSourceId = "information";
  var informationLayer = new ol.layer.Image({"querySourceId":informationSourceId, "source":new ol.source.ImageWMS({"url":"https://geomapfish-demo.camptocamp.net/1.6/wsgi/mapserv_proxy", params:{"LAYERS":"information"}})});
  ngeoQuery.addSource({"id":informationSourceId, "layer":informationLayer, "wfsQuery":true});
...
//# sourceMappingURL=bboxquery.js.map
